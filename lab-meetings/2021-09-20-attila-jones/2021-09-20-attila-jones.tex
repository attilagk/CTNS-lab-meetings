...
\only<6>{Acknowledgements

	\alert{NIA/CTNS} Madhav Thambisetty, Anjali Lathwal, group

	\alert{U.~Chicago} Hae Kyung Im, Evan Wu
	
	\alert{NIA/LBN} staff \& IT
}
